...
func separar_figurinhas(montage []int)([]int, []int){
    album := make([]int, 0, len(montage))
    repet := make([]int, 0, len(montage))
    for _, fig := range montage{
